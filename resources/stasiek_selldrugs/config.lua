Config                            = {}
Config.Locale = 'es' -- your language, It would be nice if you send me your translation on fivem forum
Config.TimeToSell = 2 -- how many seconds player have to wait/stand near ped
...
Config.WeedPrice = 1200	-- sell price for single, not pooch (black money)
Config.MethPrice = 1250	-- sell price for single, not pooch (black money)
Config.CokePrice = 1350	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 1300	-- sell price for single, not pooch (black money)
