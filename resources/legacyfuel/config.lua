...
Config.Strings = {
	ExitVehicle = "Salga del vehículo para poner gasolina",
	EToRefuel = "Presione ~g~E ~w~para colocar gasolina",
	JerryCanEmpty = "Bidon vacío",
	FullTank = "Tanque full",
	PurchaseJerryCan = "Presione ~g~E ~w~para comprar Bidon ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presione ~g~E ~w~para cancelar la gasolina",
	CancelFuelingJerryCan = "Presione ~g~E ~w~para cancelar el bidon",
	NotEnoughCash = "No tiene suficiente dinero",
	RefillJerryCan = "Presione ~g~E ~w~ para llener el Bidón para ",
